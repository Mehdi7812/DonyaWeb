...
<template>
  <section class="relative pt-40 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
    ...
    <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
      داستان <span class="bg-linear-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent">دنیاوب</span>
    </h1>

    <p class="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
      ما به این باور رسیدیم که میزبانی وب باید سریع، شفاف و بدون دردسر باشد؛ برای همین دنیاوب را ساختیم تا کسب‌وکار شما بدون نگرانی از زیرساخت، روی رشد تمرکز کند.
    </p>
  </section>
</template>
